...
function validateForm() {
    ...
    let confirmPassword = document.contactForm.confirmPassword.value;
    ...
    let nameErr = emailErr = mobileErr = passwordErr = confirmPasswordErr = countryErr = genderErr = true;
    ...
    if (nameErr || emailErr || mobileErr || passwordErr || confirmPasswordErr || countryErr || genderErr) {
        return false;
    } else {
